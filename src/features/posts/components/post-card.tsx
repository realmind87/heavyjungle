...
import { hasPostCoverMedia, PostCoverPreview } from "@/features/posts/components/post-cover-preview";
    ...
    <article className="border-b border-zinc-200 py-4 dark:border-zinc-800">
      <div className="flex items-start gap-4 px-2">
        <div className="min-w-0 flex-1">
          ...
          <Link href={postHref} className="block font-medium text-zinc-900 hover:underline dark:text-zinc-50">
            {post.title}
          </Link>
        ...
        {hasPostCoverMedia(post.coverType) && (
          <Link
            href={postHref}
            className="block h-20 w-28 shrink-0 overflow-hidden rounded-lg border border-zinc-200 dark:border-zinc-700"
            aria-hidden="true"
            tabIndex={-1}
          >
            <PostCoverPreview
