    ...
    <div className="space-y-8">
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        <div className="rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-900">
          ...
          <h4 className="mt-6 text-sm font-semibold text-zinc-900 dark:text-zinc-100">조회수 TOP 10</h4>
        ...
        <div className="rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-900">
          <h3 className={sectionTitleClass}>사용자</h3>
          <dl className="mt-4 space-y-2 text-sm">
            <div className="flex justify-between">
          ...
          <h4 className="mt-6 text-sm font-semibold text-zinc-900 dark:text-zinc-100">활발한 작성자 TOP 10</h4>
          <ul className="mt-2 space-y-2 text-sm">
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        ...
        <div className="rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-900">
          <h3 className={sectionTitleClass}>운영</h3>
          <dl className="mt-4 space-y-2 text-sm">
            <div className="flex justify-between">
          ...
          <h4 className="mt-6 text-sm font-semibold text-zinc-900 dark:text-zinc-100">최근 감사 로그</h4>
          <ul className="mt-2 space-y-2 text-sm">
