CREATE TYPE "public"."membership_role" AS ENUM('member', 'moderator', 'owner');--> statement-breakpoint
CREATE TABLE "users" (
...
CREATE UNIQUE INDEX "memberships_user_community_idx" ON "memberships" USING btree ("user_id","community_id");--> statement-breakpoint
CREATE INDEX "posts_community_created_at_idx" ON "posts" USING btree ("community_id","created_at");--> statement-breakpoint
CREATE INDEX "posts_score_idx" ON "posts" USING btree ("score");--> statement-breakpoint
